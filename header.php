...
<div class="container">
    ...
    <div class="header-inner">
      <div class="logo">
        <a class="logo-header" href="/">
          <img src="<?php echo esc_attr( get_template_directory_uri() ); ?>/assets/images/common/logo-main.svg" class="main-logo" alt="PACIFIC MALL DEVELOPMENT" />
          <img src="<?php echo esc_attr( get_template_directory_uri() ); ?>/assets/images/common/logo-fixed.svg" class="fixed-logo" alt="PACIFIC MALL DEVELOPMENT" />
        </a>
      </div>
  ...
  <section class="section-contents" id="keyvisual">
    <img src="<?php echo esc_attr( get_template_directory_uri() ); ?>/assets/images/bg-section-keyvisual.jpg" alt="MAIN IMAGE" />
    <div class="wrapper">
